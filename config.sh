...
# set automatic phase encoding scheme or manually set by user 
# options : "AP" "PA" "RL" "IS" ... default: "auto"
export PE="PA"
...
# options ["fsl", "freesurfer", "none"]; default: "fsl"
export ACT="freesurfer"
